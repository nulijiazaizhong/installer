...
!define GITHUB_PROXY_URL "https://proxy-github.ets2la.cn/github.com/ETS2LA/Euro-Truck-Simulator-2-Lane-Assist"
...
Function SelectMirrorPage
    ...
    Pop $RadioGitHub
    ${NSD_CreateRadioButton} 0 60u 100% 12u "GitHub Proxy"
    Pop $RadioGitHubProxy
    ${NSD_CreateRadioButton} 0 75u 100% 12u "SourceForge"
...
Function SelectMirrorPageLeave
    ...
    ${Else}
        ...
        ${Else}
            ${NSD_GetState} $RadioGitHubProxy $0
            ${If} $0 == ${BST_CHECKED}
                StrCpy $MirrorSelection "GitHubProxy"
            ${Else}
...
Section "Download" SEC03
    ...
    ${ElseIf} $MirrorSelection == "GitHubProxy"
        nsExec::ExecToLog '"$INSTDIR\system\git\bin\git.exe" clone --quiet --depth=20 --branch=${BRANCH} --single-branch ${GITHUB_PROXY_URL} .'
    ...
    ${If} $0 != 0
        ...
        ${If} $MirrorSelection == "GitLab"
            ...
            ${If} $0 != 0
                ...
                ${If} $0 != 0
                    DetailPrint $(TryingAnotherMirror)
                    DetailPrint "GitHub Proxy"
                    nsExec::ExecToLog '"$INSTDIR\system\git\bin\git.exe" clone --quiet --depth=20 --branch=${BRANCH} --single-branch ${GITHUB_PROXY_URL} .' $0
                    Pop $0
                    ${If} $0 != 0
                        DetailPrint $(TryingAnotherMirror)
                        DetailPrint "CNB"
